                    ...
                    ?>
                        <tr>
                            ...
                            <td><?php
                                if ($row['receipt']) {
                                    echo $row['receipt'];
                                    echo "<a href='' class='btn' data-bs-toggle='modal' data-bs-target='#modalNoResi$row[ID]'><i class='bx bx-edit-alt icon'></i></a>";
                                } else {
                                    echo "<button class='btn btn-danger' data-bs-toggle='modal' data-bs-target='#modalNoResi$row[ID]'>Update</button>";
                                }
                                ?></td>
                            <td class="text-end">
                        ...
                        <!-- NOMOR RESI-->
                        <div class="modal fade modal-lg" id="modalNoResi<?= $row['ID'] ?>" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    <div class="modal-header">
